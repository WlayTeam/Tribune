<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><html><body><div class="entry">
 <div class="copyright-area">
  原文出处：
  <a href="http://zalezone.cn/2014/09/17/NIO%E7%B2%BE%E7%B2%B9/" ref="nofollow" target="_blank">
   zale zhang
  </a>
 </div>
 <h1 id="u524D_u8A00">
 ...
 <h2 id="java_NIO_u7684_u601D_u7EF4_u5BFC_u56FE_3A">
  java NIO的思维导图:
 </h2>
 <p style="text-align: center;">
  <a class="external" href="http://zalezone.cn/image/javaNIO.png" rel="article0 nofollow" target="_blank" title="javaNIO">
   <img alt="javaNIO" class="aligncenter" data-url="/image/javaNIO.png" src="http://zalezone.cn/image/javaNIO.png"/>
  </a>
  javaNIO
 </p>
 <h3 id="JVM_u5229_u5F0A">
  JVM利弊
 </h3>
 <p>
 ...
 <p>
  怎么办呢?如果您是程序员,可以使用 Java 本地接口(
  <a class="external" href="http://baike.baidu.com/view/1272329.htm" rel="external nofollow" target="_blank">
   JNI
  </a>
  )编写本地代码,直接使用操作系统特性。这样的话，不同的操作系统的局限性就体现出来了。为了解决这一问题,java.nio 软件包提供了新的抽象。具体地说,就是 Channel 和 Selector类。它们提供了使用 I/O 服务的通用 API,JDK 1.4 以前的版本是无法使用这些服务的。天下还是没有免费的午餐:您无法使用每一种操作系统的每一种特性,但是这些新类还是提供了强大的新框架,涵盖了当今商业操作系统普遍提供的高效 I/O 特性。不仅如此,java.nio.channels.spi还提供了新的服务提供接口(SPI),允许接入新型通道和选择器,同时又不违反规范的一致性。
 </p>
 <p>
  随着 NIO 的面世,Java 已经为严肃的商业、娱乐、科研和学术应用做好了准备。在这些领域,高性能 I/O 是必不可少的。
 </p>
 <h1 id="NIO_u539F_u7406">
  NIO原理
 </h1>
 <h2 id="NIO_u4E0EIO_u7684_u533A_u522B">
  NIO与IO的区别
 </h2>
 <p>
  首先来讲一下传统的IO和NIO的区别，传统的IO又称BIO，即阻塞式IO，NIO就是非阻塞IO了。还有一种
  <a class="external" href="http://stevex.blog.51cto.com/4300375/1284437" rel="external nofollow" target="_blank">
   AIO
  </a>
  就是异步IO，这里不加阐述了。
 </p>
 ...
 <p>
  <a class="external" href="http://zalezone.cn/image/Bytebuffer.png" rel="article0 nofollow" target="_blank" title="ByteBuffer">
   <img alt="ByteBuffer" class="aligncenter" data-url="/image/Bytebuffer.png" src="http://zalezone.cn/image/Bytebuffer.png"/>
  </a>
 </p>
 <p style="text-align: center;">
  ByteBuffer
 ...
 <p>
  <a href="http://www.importnew.com/?attachment_id=22624" rel="attachment wp-att-22624">
   <img alt="" class="size-full wp-image-22624 aligncenter" src="http://incdn1.b0.upaiyun.com/2016/12/a3164c18ca98748e1af313e58636855b.png" title="channel"/>
  </a>
 </p>
 <p style="text-align: center;">
  channel
 ...
 <p>
  ...
  <br/>
  <a href="http://www.importnew.com/?attachment_id=22625" rel="attachment wp-att-22625">
   <img alt="" class="size-full wp-image-22625 aligncenter" src="http://incdn1.b0.upaiyun.com/2016/12/f582dc21d5a9ffb1bbfadf74318bc5a6.png" title="Selector"/>
  </a>
 </p>
 <p style="text-align: center;">
  Selector
 ...
 <pre class="brush: java; gutter: true">if (key.isWritable( ))
等价于:
if ((key.readyOps( ) &amp; SelectionKey.OP_WRITE) != 0)</pre>
 <p>
 ...
 <pre class="brush: java; gutter: true">import java.net.InetSocketAddress;
...
public class SelectSocketsThreadPool extends SelectSockets 
{
 ...
 <p>
  ...
  ：
  <a class="external" href="http://book.douban.com/subject/1433583/" rel="external nofollow" target="_blank">
   《java NIO》
  </a>
 </p>
 <!-- BEGIN #author-bio -->
